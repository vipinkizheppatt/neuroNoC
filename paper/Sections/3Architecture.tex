...
%\label{equation:btod}
%\end{equation*}
%Here, n_{x}, i_{x}, f_{x} amount to total number of bits, integer bits and fractional bits of the given variable.
%
%
...
%
\begin{figure}[!h]
    \includegraphics[width=\columnwidth]{Figures/snc.pdf}
    \caption{SNC Architecture} 
    \label{figure:snc}
\end{figure}
%
\begin{figure}[!h]
    \includegraphics[width=\columnwidth]{Figures/sst.pdf}
    \caption{SST} 
    \label{figure:sst}
\end{figure}
%
...
%where $SEQ_WIDTH$ amounts to the number of bits in the seqNum field. For the sake of full
%configurability, for the given NOC of size S_{NOC}, each PE can be configured to receive inputs
...
\begin{figure}[!h]
    \includegraphics[width=\columnwidth]{Figures/mac.pdf}
    \caption{MAC Architecture} 
    \label{figure:mac}
\end{figure} 
%
%\subsection{AF}
...
\begin{figure}[!h]
    \includegraphics[width=\columnwidth]{Figures/af.pdf}
    \caption{AF Architecture} 
    \label{figure:af}
\end{figure} 
%
%\subsection{NoC}
...
%
\begin{figure}
    \includegraphics[width=\columnwidth]{Figures/mesh.pdf}
    \caption{MESH} 
    \label{figure:mesh}
\end{figure}
%
...
%
\begin{figure}
    \includegraphics[width=\columnwidth]{Figures/switch_architecture.pdf}
...
%
\begin{figure}
    \includegraphics[width=\columnwidth]{Figures/fsm.pdf}
    \caption{FSM} 
    \label{figure:fsm}
\end{figure}
